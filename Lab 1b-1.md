...
Wget 
I have gotten 3 books by using the "wget" command and stored 3 of the textfiles into a directory "mkdir Books" and create an archieve file from the directory Books with "tar cf books.tar Books"
